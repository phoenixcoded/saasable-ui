              ...
              <TabPanel value={String(index + 1)} key={index} sx={{ p: 0, width: 1 }}>
                <Grid container spacing={1.5}>
                  <Grid size={{ xs: 12, sm: 5 }}>
                    <GraphicsCard sx={{ p: { xs: 3, md: 8 }, minHeight: { xs: 260, sm: 396, md: 434 }, height: 1 }}>
                      <GraphicsImage sx={{ height: 1, backgroundPosition: 'center', backgroundSize: 'contain' }} image={item.image} />
                    </GraphicsCard>
                  </Grid>
                      ...
                      {(item.actionBtn || item.actionBtn2) && (
                        <GraphicsCard sx={{ bgcolor: 'grey.200' }}>
                          <Stack direction="row" sx={{ alignItems: 'flex-start', gap: 1.5, p: { xs: 2, sm: 3, md: 4 } }}>
                            {item.actionBtn2 && <Button variant="outlined" color="primary" {...item.actionBtn2} />}
